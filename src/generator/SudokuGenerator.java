...
//        System.out.println("and solve...");
	 ...
	 * <code>null</code>, it is used to determine the positions of the givens. If no
	 ...
	 * The method works very well most of the times, but somtimes (about 1.5% of all
	 * cases) it can take extremely long to get a solution. It is then better to
	 * abort and try with a new randomized index set.
	 */
	...
	/**
	 * Takes a full sudoku from {@link #newFullSudoku} and generates a valid puzzle
...
//        System.out.println(bs.getSolutionAsString() + " (" + bs.getSolutionCount() + ")");
		...
		for (int i = 0; i < anzRuns; i++) {
			...
			// 1
			// bs.solve("...7..8......4..3......9..16..5......1..3..4...5..1..75..2..6...3..8..9...7.....2");
