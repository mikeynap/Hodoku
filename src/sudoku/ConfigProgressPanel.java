 ...
 * @author hobiwan
 */
public class ConfigProgressPanel extends javax.swing.JPanel implements ListDragAndDropChange {
	private static final SSTSConfig[] SSTS_CONFIG = new SSTSConfig[] { new SSTSConfig(SolutionType.FULL_HOUSE, 100),
			new SSTSConfig(SolutionType.NAKED_SINGLE, 200), new SSTSConfig(SolutionType.HIDDEN_SINGLE, 300),
			new SSTSConfig(SolutionType.LOCKED_PAIR, 1000), new SSTSConfig(SolutionType.NAKED_PAIR, 1100),
			new SSTSConfig(SolutionType.LOCKED_CANDIDATES, 1200), new SSTSConfig(SolutionType.LOCKED_TRIPLE, 1300),
			new SSTSConfig(SolutionType.NAKED_TRIPLE, 1400), new SSTSConfig(SolutionType.NAKED_QUADRUPLE, 1500),
			new SSTSConfig(SolutionType.HIDDEN_PAIR, 1600), new SSTSConfig(SolutionType.X_WING, 2000),
			new SSTSConfig(SolutionType.SWORDFISH, 2100), new SSTSConfig(SolutionType.SIMPLE_COLORS, 2200),
			new SSTSConfig(SolutionType.MULTI_COLORS, 2300), new SSTSConfig(SolutionType.HIDDEN_TRIPLE, 2400),
			new SSTSConfig(SolutionType.XY_WING, 2500), new SSTSConfig(SolutionType.HIDDEN_QUADRUPLE, 2600) };
	...
	private void initComponents() {
		...
		upButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigProgressPanel")
				.getString("ConfigProgressPanel.upButton.mnemonic").charAt(0));
		...
		downButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigProgressPanel")
				.getString("ConfigProgressPanel.downButton.mnemonic").charAt(0));
		...
		resetButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigProgressPanel")
				.getString("ConfigProgressPanel.resetButton.mnemonic").charAt(0));
		...
		sstsButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigProgressPanel")
				.getString("ConfigProgressPanel.sstsButton.mnemonic").charAt(0));
		...
		mediumButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigProgressPanel")
				.getString("ConfigProgressPanel.mediumButton.mnemonic").charAt(0));
		...
		mediumPlusHardButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigProgressPanel")
				.getString("ConfigProgressPanel.mediumPlusHardButton.mnemonic").charAt(0));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup()
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(jPanel1Layout.createSequentialGroup().addComponent(upButton)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 54,
												Short.MAX_VALUE)
										.addComponent(sstsButton))
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanel1Layout.createSequentialGroup().addContainerGap(113, Short.MAX_VALUE)
		...
		jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { mediumButton, mediumPlusHardButton, resetButton, sstsButton });

		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
						.addContainerGap(327, Short.MAX_VALUE).addComponent(mediumPlusHardButton)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(mediumButton)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(upButton).addComponent(sstsButton))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
	...
	/**
	 * Sets one step according to the contents of <code>config</code>. If the
	...
	private void setOneSSTSStep(SSTSConfig config) {
		...
		// System.out.println("Step: " + step + "/" + step.isEnabled() + "/" +
		// step.isEnabledProgress() + "/" + step.getIndexProgress());
	}
...
//        Options.getInstance().sortProgressSteps();
	...
	private void initAll(boolean setDefault) {
		...
		if (setDefault) {
			...
			steps = Options.getInstance().copyStepConfigs(Options.getInstance().solverStepsProgress, true, false, false,
					true);
