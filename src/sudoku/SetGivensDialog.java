...
public class SetGivensDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		okButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/SetGivensDialog")
				.getString("SetGivensDialog.okButton.mnemonic").charAt(0));
		...
		cancelButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/SetGivensDialog")
				.getString("SetGivensDialog.cancelButton.mnemonics").charAt(0));
