...
public class BackdoorSearchDialog extends javax.swing.JDialog implements Runnable {
	...
	private DefaultListModel<String> singlesListModel;
...
//    private Sudoku2 solvedSudoku;
	...
	public BackdoorSearchDialog(java.awt.Frame parent, boolean modal, SudokuPanel sudokuPanel) {
		...
		progressListModel = new DefaultListModel<String>();
	...
	private void initComponents() {
		...
		candComboBox = new javax.swing.JComboBox<String>();
		...
		singlesResultList = new javax.swing.JList<String>();
		progressResultPanel = new javax.swing.JPanel();
		progressResultLabel = new javax.swing.JLabel();
		jScrollPane2 = new javax.swing.JScrollPane();
		progressResultList = new javax.swing.JList<String>();
		...
		configPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("BackDoorSearchDialog.configPanel.title"))); // NOI18N

		cellsCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchPanel.cellsCheckBox.mnemonic").charAt(0));
		...
		candidatesCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchPanel.candidatesCheckBox.mnemonic").charAt(0));
		...
		candLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchPanel.candLabel.mnemonic").charAt(0));
		candLabel.setLabelFor(candComboBox);
		candLabel.setText(bundle.getString("BackdoorSearchPanel.candLabel.text")); // NOI18N

		candComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "1", "2", "3" }));
		...
		configPanelLayout
				.setHorizontalGroup(
						configPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(configPanelLayout.createSequentialGroup().addContainerGap()
										.addComponent(cellsCheckBox).addGap(18, 18, 18).addComponent(candidatesCheckBox)
										.addGap(18, 18, 18).addComponent(candLabel)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(candComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 58,
		...
		configPanelLayout.setVerticalGroup(configPanelLayout
				...
				.addGroup(configPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(configPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(cellsCheckBox).addComponent(candidatesCheckBox).addComponent(candLabel)
								.addComponent(candComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));

		progressPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("BackdoorSearchDialog.progressPanel.title"))); // NOI18N
		...
		progressPanelLayout.setHorizontalGroup(progressPanelLayout
				...
				.addGroup(progressPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(progressPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(searchLabel).addComponent(searchProgressBar,
										javax.swing.GroupLayout.DEFAULT_SIZE, 512, Short.MAX_VALUE))
						.addContainerGap()));
		progressPanelLayout.setVerticalGroup(progressPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(progressPanelLayout.createSequentialGroup().addContainerGap().addComponent(searchLabel)
		...
		resultPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("BackdoorSearchDialog.resultPanel.title"))); // NOI18N

		singlesResultLabel.setText(bundle.getString("BackdoorSearchDialog.singlesResultLabel.text")); // NOI18N

		singlesResultList.setModel(new javax.swing.AbstractListModel<String>() {
		...
		singlesResultPanelLayout.setHorizontalGroup(
				singlesResultPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(singlesResultPanelLayout.createSequentialGroup().addComponent(singlesResultLabel)
								.addContainerGap(135, Short.MAX_VALUE))
						.addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE));
		singlesResultPanelLayout.setVerticalGroup(singlesResultPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(singlesResultPanelLayout.createSequentialGroup().addComponent(singlesResultLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		progressResultList.setModel(new javax.swing.AbstractListModel<String>() {
			String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
		...
		progressResultPanelLayout.setHorizontalGroup(progressResultPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(progressResultPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(progressResultPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
								.addGroup(progressResultPanelLayout.createSequentialGroup()
										.addComponent(progressResultLabel).addContainerGap(132, Short.MAX_VALUE)))));
		progressResultPanelLayout.setVerticalGroup(progressResultPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(progressResultPanelLayout.createSequentialGroup().addComponent(progressResultLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		resultPanelLayout
				.setHorizontalGroup(
						resultPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(resultPanelLayout.createSequentialGroup().addContainerGap()
										.addComponent(singlesResultPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(progressResultPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addContainerGap()));
		resultPanelLayout.setVerticalGroup(resultPanelLayout
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, resultPanelLayout.createSequentialGroup()
						.addGroup(resultPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(progressResultPanel, javax.swing.GroupLayout.Alignment.LEADING,
		...
		startButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchDialog.startButton.mnemonic").charAt(0));
		...
		closeButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchDialog.stopButton.mnemonic").charAt(0));
		...
		stopButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchDialog.closeButton.mnemonic").charAt(0));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				...
				layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(resultPanel, javax.swing.GroupLayout.Alignment.LEADING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(progressPanel, javax.swing.GroupLayout.Alignment.LEADING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(configPanel, javax.swing.GroupLayout.Alignment.LEADING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addGroup(layout.createSequentialGroup().addComponent(startButton).addGap(6, 6, 6)
		...
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { closeButton, startButton, stopButton });

		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addComponent(configPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(startButton).addComponent(closeButton).addComponent(stopButton))
						.addContainerGap()));
		...
		if (visible) {
			...
			if (anz <= 16) {
				JOptionPane.showMessageDialog(this,
						ResourceBundle.getBundle("intl/BackdoorSearchDialog")
								.getString("BackdoorSearchDialog.error.message") + " (" + anz + ")",
						ResourceBundle.getBundle("intl/BackdoorSearchDialog")
								.getString("BackdoorSearchDialog.error.title"),
	...
	/**
	 * The search is done in a background thread: A maximum of 12 searches is
	 * conducted (singles/progress, cells/candidates, up to combinations of
	 * three).<br>
	 */
	@Override
	public void run() {
//        System.out.println("Thread started!");
		...
		try {
			...
			if (Options.getInstance().isBdsSearchForCandidates()) {
				...
				if (!checkCandidates(1, anz, candidates, Options.getInstance().solverStepsProgress) && maxDepth > 1) {
					int maxAnz = SudokuUtil.combinations(anz, 2);
					// System.out.println("thread: search 2 (" + maxAnz + ")");
					if (!checkCandidates(2, maxAnz, candidates, Options.getInstance().solverStepsProgress)
							&& maxDepth > 2) {
						maxAnz = SudokuUtil.combinations(anz, 3);
						// System.out.println("thread: search 3 (" + maxAnz + ")");
		...
		// normal end
		setFinished(true);
		triggerUpdateProgressbar(ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchDialog.searchLabel.text"), 100, 100);
		EventQueue.invokeLater(updateRunnable);
...
//            System.out.println("adjust: stopped");
	...
	/**
	 * Reads all available items from the queues and adds them to the lists.<br>
	 * <b>CAUTION:</b> Must be called from within the swing thread (either from an
	 * event handler or via {@link #updateRunnable}.
	 */
	private void update() {
		String str = null;
	...
	private boolean checkCandidates(int depth, int max, List<Candidate> candidates, StepConfig[] stepConfigs)
		...
		int counter = 0;
		String startStr = ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchDialog.search_candidates") + " (";
		if (stepConfigs == null) {
			startStr += ResourceBundle.getBundle("intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.singles");
		} else {
			startStr += ResourceBundle.getBundle("intl/BackdoorSearchDialog")
					.getString("BackdoorSearchDialog.progress");
		}
		startStr += " - ";
		String label = startStr + ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchDialog.search_candidates1");
		if (depth == 2) {
			label = startStr + ResourceBundle.getBundle("intl/BackdoorSearchDialog")
					.getString("BackdoorSearchDialog.search_candidates2");
		} else if (depth == 3) {
			label = startStr + ResourceBundle.getBundle("intl/BackdoorSearchDialog")
					.getString("BackdoorSearchDialog.search_candidates3");
		}
		label += ")";
		for (int i = 0; i < end; i++) {
			if (depth == 1) {
				...
				for (int j = i + 1; j < end; j++) {
					if (depth == 2) {
						if (checkSingleOrCandidate(-1, -1, -1, candidates.get(i), candidates.get(j), null,
								stepConfigs)) {
							found = true;
							incAnzFound();
							if (getAnzFound() > MAX_FOUND) {
						...
						for (int k = j + 1; k < end; k++) {
							if (checkSingleOrCandidate(-1, -1, -1, candidates.get(i), candidates.get(j),
									candidates.get(k), stepConfigs)) {
								found = true;
								incAnzFound();
								if (getAnzFound() > MAX_FOUND) {
									return true;
	...
	private boolean checkSingles(int depth, int max, StepConfig[] stepConfigs) throws InterruptedException {
		...
		int counter = 0;
		String startStr = ResourceBundle.getBundle("intl/BackdoorSearchDialog")
				.getString("BackdoorSearchDialog.search_cells") + " (";
		if (stepConfigs == null) {
			startStr += ResourceBundle.getBundle("intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.singles");
		} else {
			startStr += ResourceBundle.getBundle("intl/BackdoorSearchDialog")
		...
		startStr += " - ";
		String label = startStr
				+ ResourceBundle.getBundle("intl/BackdoorSearchDialog").getString("BackdoorSearchDialog.search_cells1");
		if (depth == 2) {
			label = startStr + ResourceBundle.getBundle("intl/BackdoorSearchDialog")
					.getString("BackdoorSearchDialog.search_cells2");
		} else if (depth == 3) {
			label = startStr + ResourceBundle.getBundle("intl/BackdoorSearchDialog")
					.getString("BackdoorSearchDialog.search_cells3");
		}
		label += ")";
		for (int i = 0; i < end; i++) {
	...
	/**
	 * Checks if the sudoku can be solved with singles only or with the techniques
	 * defined in {@link Options#solverStepsProgress}, after the cells
	 * <code>index1</code>, <code>index2</code> and <code>index3</code> have been
	 * set. If <code>index2</code> and/or <code>index3</code> are <code>-1</code>,
	 * they are ignored.<br>
	 ...
	 * @return
	 */
	private boolean checkSingleOrCandidate(int index1, int index2, int index3, Candidate cand1, Candidate cand2,
			Candidate cand3, StepConfig[] stepConfigs) throws InterruptedException {
...
//            }
	...
	private javax.swing.JComboBox<String> candComboBox;
	...
	private javax.swing.JList<String> progressResultList;
	...
	private javax.swing.JList<String> singlesResultList;
