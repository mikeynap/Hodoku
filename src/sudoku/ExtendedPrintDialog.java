...
public class ExtendedPrintDialog extends javax.swing.JDialog {
	...
	private static final Icon[] images = new ImageIcon[] {
			new ImageIcon(
					Toolkit.getDefaultToolkit().getImage(ExtendedPrintDialog.class.getResource("/img/slh1th.png"))),
			new ImageIcon(
					Toolkit.getDefaultToolkit().getImage(ExtendedPrintDialog.class.getResource("/img/slh2th.png"))),
			new ImageIcon(
					Toolkit.getDefaultToolkit().getImage(ExtendedPrintDialog.class.getResource("/img/slh4th.png"))),
			new ImageIcon(
					Toolkit.getDefaultToolkit().getImage(ExtendedPrintDialog.class.getResource("/img/slq2th.png"))),
			new ImageIcon(
					Toolkit.getDefaultToolkit().getImage(ExtendedPrintDialog.class.getResource("/img/slq4th.png"))) };
	...
	public ExtendedPrintDialog(java.awt.Frame parent, boolean modal) {
		...
		numberTextFields = new JTextField[] { numberOfPuzzles1TextField, numberOfPuzzles2TextField,
				numberOfPuzzles3TextField, numberOfPuzzles4TextField, numberOfPuzzles5TextField };
		levelComboBoxes = new JComboBox[] { level1ComboBox, level2ComboBox, level3ComboBox, level4ComboBox,
				level5ComboBox };
		modeComboBoxes = new JComboBox[] { mode1ComboBox, mode2ComboBox, mode3ComboBox, mode4ComboBox, mode5ComboBox };
		candCheckBoxes = new JCheckBox[] { printCands1CheckBox, printCands2CheckBox, printCands3CheckBox,
	...
	private void initComponents() {
		...
		layoutList = new javax.swing.JList<Integer>();
		...
		jPanel1.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ExtendedPrintDialog.jPanel1.border.title"))); // NOI18N
		...
		printRatingCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ExtendedPrintDialog")
				.getString("ExtendedPrintDialog.printRatingCheckBox.mnemonic").charAt(0));
		...
		printAllBlackCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ExtendedPrintDialog")
				.getString("ExtendedPrintDialog.printAllBlackCheckBox.mnemonic").charAt(0));
		printAllBlackCheckBox.setText(bundle.getString("ExtendedPrintDialog.printAllBlackCheckBox.text")); // NOI18N

		printBookletCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ExtendedPrintDialog")
				.getString("ExtendedPrintDialog.printBookletCheckBox.mnemonic").charAt(0));
		...
		manualDuplexCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ExtendedPrintDialog")
				.getString("ExtendedPrintDialog.manualDuplexCheckBox.mnemonic").charAt(0));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(printRatingCheckBox).addComponent(printAllBlackCheckBox))
						.addGap(18, 18, 18)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(manualDuplexCheckBox).addComponent(printBookletCheckBox))
						.addContainerGap())
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(printRatingCheckBox).addComponent(printBookletCheckBox))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(printAllBlackCheckBox).addComponent(manualDuplexCheckBox))
						.addContainerGap()));

		printButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ExtendedPrintDialog")
				.getString("ExtendedPrintDialog.printButton.mnemonic").charAt(0));
		...
		pageSetupButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ExtendedPrintDialog")
				.getString("ExtendedPrintDialog.pageSetupButton.mnemonic").charAt(0));
		...
		cancelButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ExtendedPrintDialog")
				.getString("ExtendedPrintDialog.cancelButton.mnemonic").charAt(0));
		...
		section1Panel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ExtendedPrintDialog.section1Panel.border.title"))); // NOI18N
		...
		section1PanelLayout.setHorizontalGroup(section1PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section1PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section1PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(numberOfPuzzles1Label).addComponent(level1Label).addComponent(mode1Label))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section1PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(printCands1CheckBox)
								.addComponent(numberOfPuzzles1TextField, javax.swing.GroupLayout.DEFAULT_SIZE, 349,
										Short.MAX_VALUE)
								.addComponent(level1ComboBox, 0, 349, Short.MAX_VALUE)
								.addComponent(mode1ComboBox, 0, 349, Short.MAX_VALUE))
						.addContainerGap()));
		section1PanelLayout.setVerticalGroup(section1PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section1PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section1PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(numberOfPuzzles1Label).addComponent(numberOfPuzzles1TextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section1PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(level1Label).addComponent(level1ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section1PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(mode1Label).addComponent(mode1ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(printCands1CheckBox)
		...
		section2Panel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ExtendedPrintDialog.section2Panel.border.title"))); // NOI18N
		...
		section2PanelLayout.setHorizontalGroup(section2PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section2PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section2PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(numberOfPuzzles2Label).addComponent(level2Label).addComponent(mode2Label))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section2PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(printCands2CheckBox)
								.addComponent(numberOfPuzzles2TextField, javax.swing.GroupLayout.DEFAULT_SIZE, 349,
										Short.MAX_VALUE)
								.addComponent(level2ComboBox, 0, 349, Short.MAX_VALUE)
								.addComponent(mode2ComboBox, 0, 349, Short.MAX_VALUE))
						.addContainerGap()));
		section2PanelLayout.setVerticalGroup(section2PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section2PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section2PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(numberOfPuzzles2Label).addComponent(numberOfPuzzles2TextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section2PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(level2Label).addComponent(level2ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section2PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(mode2Label).addComponent(mode2ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(printCands2CheckBox)
		...
		section3Panel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ExtendedPrintDialog.section3Panel.border.title"))); // NOI18N
		...
		section3PanelLayout.setHorizontalGroup(section3PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section3PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section3PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(numberOfPuzzles3Label).addComponent(level3Label).addComponent(mode3Label))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section3PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(printCands3CheckBox)
								.addComponent(numberOfPuzzles3TextField, javax.swing.GroupLayout.DEFAULT_SIZE, 349,
										Short.MAX_VALUE)
								.addComponent(level3ComboBox, 0, 349, Short.MAX_VALUE)
								.addComponent(mode3ComboBox, 0, 349, Short.MAX_VALUE))
						.addContainerGap()));
		section3PanelLayout.setVerticalGroup(section3PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section3PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section3PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(numberOfPuzzles3Label).addComponent(numberOfPuzzles3TextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section3PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(level3Label).addComponent(level3ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section3PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(mode3Label).addComponent(mode3ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(printCands3CheckBox)
		...
		section4Panel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ExtendedPrintDialog.section4Panel.border.title"))); // NOI18N
		...
		section4PanelLayout.setHorizontalGroup(section4PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section4PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section4PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(numberOfPuzzles4Label).addComponent(level4Label).addComponent(mode4Label))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section4PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(printCands4CheckBox)
								.addComponent(numberOfPuzzles4TextField, javax.swing.GroupLayout.DEFAULT_SIZE, 349,
										Short.MAX_VALUE)
								.addComponent(level4ComboBox, 0, 349, Short.MAX_VALUE)
								.addComponent(mode4ComboBox, 0, 349, Short.MAX_VALUE))
						.addContainerGap()));
		section4PanelLayout.setVerticalGroup(section4PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section4PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section4PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(numberOfPuzzles4Label).addComponent(numberOfPuzzles4TextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section4PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(level4Label).addComponent(level4ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section4PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(mode4Label).addComponent(mode4ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(printCands4CheckBox)
		...
		section5Panel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ExtendedPrintDialog.section5Panel.border.title"))); // NOI18N
		...
		section5PanelLayout.setHorizontalGroup(section5PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section5PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section5PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(numberOfPuzzles5Label).addComponent(level5Label).addComponent(mode5Label))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section5PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(printCands5CheckBox)
								.addComponent(numberOfPuzzles5TextField, javax.swing.GroupLayout.DEFAULT_SIZE, 349,
										Short.MAX_VALUE)
								.addComponent(level5ComboBox, 0, 349, Short.MAX_VALUE)
								.addComponent(mode5ComboBox, 0, 349, Short.MAX_VALUE))
						.addContainerGap()));
		section5PanelLayout.setVerticalGroup(section5PanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(section5PanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(section5PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(numberOfPuzzles5Label).addComponent(numberOfPuzzles5TextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section5PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(level5Label).addComponent(level5ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(section5PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(mode5Label).addComponent(mode5ComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(printCands5CheckBox)
		...
		sectionContainerPanelLayout.setHorizontalGroup(sectionContainerPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(section1Panel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
				.addComponent(section2Panel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
				.addComponent(section3Panel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
				.addComponent(section4Panel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
				.addComponent(section5Panel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE));
		sectionContainerPanelLayout.setVerticalGroup(
				sectionContainerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(sectionContainerPanelLayout.createSequentialGroup()
								.addComponent(section1Panel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(section2Panel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(section3Panel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(section4Panel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(section5Panel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
		...
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { cancelButton, pageSetupButton, printButton });
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(printButton).addComponent(pageSetupButton).addComponent(cancelButton))
						.addContainerGap()));
	...
	private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_printButtonActionPerformed
		...
		if (printBooklet && layout < 3) {
			...
			JOptionPane.showMessageDialog(this,
					ResourceBundle.getBundle("intl/ExtendedPrintDialog")
							.getString("ExtendedPrintDialog.wrongOrientation"),
					java.util.ResourceBundle.getBundle("intl/MainFrame").getString("MainFrame.error"),
					JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		pageFormat = SudokuUtil.getPageFormat();
		adjustOrientation();
		ExtendedPrintProgressDialog dlg = new ExtendedPrintProgressDialog(null, true, numberTextFields, levelComboBoxes,
				modeComboBoxes, candCheckBoxes, layout, printRating, allBlack, printBooklet, manualDuplex);
...
//            setFont(list.getFont());
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ExtendedPrintDialog.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
	...
	private javax.swing.JList<Integer> layoutList;
	@SuppressWarnings("rawtypes")
