...
public enum SolutionType {
	...
	LOCKED_CANDIDATES(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Locked_Candidates"), "xxxx",
			"lc"),
	LOCKED_CANDIDATES_1(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Locked_Candidates_Type_1_(Pointing)"),
			"0100", "lc1"),
	LOCKED_CANDIDATES_2(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Locked_Candidates_Type_2_(Claiming)"),
			"0101", "lc2"),
	...
	CONTINUOUS_NICE_LOOP(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Continuous_Nice_Loop"),
			"0706", "cnl"),
	DISCONTINUOUS_NICE_LOOP(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Discontinuous_Nice_Loop"), "0707",
			"dnl"),
	...
	FRANKEN_LEVIATHAN(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Franken_Leviathan"), "0335",
			"ff7"),
	FINNED_FRANKEN_X_WING(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Franken_X-Wing"),
			"0340", "fff2"),
	FINNED_FRANKEN_SWORDFISH(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Franken_Swordfish"), "0341",
			"fff3"),
	FINNED_FRANKEN_JELLYFISH(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Franken_Jellyfish"), "0342",
			"fff4"),
	FINNED_FRANKEN_SQUIRMBAG(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Franken_Squirmbag"), "0343",
			"fff5"),
	FINNED_FRANKEN_WHALE(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Franken_Whale"),
			"0344", "fff6"),
	FINNED_FRANKEN_LEVIATHAN(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Franken_Leviathan"), "0345",
			"fff7"),
	...
	MUTANT_LEVIATHAN(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Mutant_Leviathan"), "0355",
			"mf7"),
	FINNED_MUTANT_X_WING(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Mutant_X-Wing"),
			"0360", "fmf2"),
	FINNED_MUTANT_SWORDFISH(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Mutant_Swordfish"), "0361",
			"fmf3"),
	FINNED_MUTANT_JELLYFISH(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Mutant_Jellyfish"), "0362",
			"fmf4"),
	FINNED_MUTANT_SQUIRMBAG(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Mutant_Squirmbag"), "0363",
			"fmf5"),
	FINNED_MUTANT_WHALE(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Mutant_Whale"),
			"0364", "fmf6"),
	FINNED_MUTANT_LEVIATHAN(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Finned_Mutant_Leviathan"), "0365",
			"fmf7"),
	SUE_DE_COQ(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Sue_de_Coq"), "1101", "sdc"),
	ALS_XZ(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Almost_Locked_Set_XZ-Rule"), "0901",
			"axz"),
	ALS_XY_WING(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Almost_Locked_Set_XY-Wing"), "0902",
			"axy"),
	ALS_XY_CHAIN(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Almost_Locked_Set_XY-Chain"),
			"0903", "ach"),
	...
	FORCING_CHAIN_CONTRADICTION(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Forcing_Chain_Contradiction"), "1301",
			"fcc"),
	FORCING_CHAIN_VERITY(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Forcing_Chain_Verity"),
			"1302", "fcv"),
	FORCING_NET(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Forcing_Net"), "xxxx", "fn"),
	FORCING_NET_CONTRADICTION(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Forcing_Net_Contradiction"), "1303",
			"fnc"),
	FORCING_NET_VERITY(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Forcing_Net_Verity"), "1304",
			"fnv"),
	...
	GROUPED_NICE_LOOP(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Grouped_Nice_Loop/AIC"),
			"xxxx", "gnl"),
	GROUPED_CONTINUOUS_NICE_LOOP(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Grouped_Continuous_Nice_Loop"), "0709",
			"gcnl"),
	GROUPED_DISCONTINUOUS_NICE_LOOP(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Grouped_Discontinuous_Nice_Loop"),
			"0710", "gdnl"),
	...
	AVOIDABLE_RECTANGLE_1(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Avoidable_Rectangle_Type_1"), "0607",
			"ar1"),
	AVOIDABLE_RECTANGLE_2(
			java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Avoidable_Rectangle_Type_2"), "0608",
			"ar2"),
	...
	KRAKEN_FISH_TYPE_1(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Kraken_Fish_Type_1"), "0371",
			"kf1"),
	KRAKEN_FISH_TYPE_2(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Kraken_Fish_Type_2"), "0372",
			"kf2"),
	DUAL_TWO_STRING_KITE(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Dual_2-String_Kite"),
			"0404", "d2sk"),
	DUAL_EMPTY_RECTANGLE(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Dual_Empty_Rectangle"),
			"0405", "der"),
	SIMPLE_COLORS_TRAP(java.util.ResourceBundle.getBundle("intl/SolutionType").getString("Simple_Colors_Trap"), "0500",
			"sc1"),
