...
public class ConfigGeneralPanel extends javax.swing.JPanel {
	...
	/*
	 * All available languages as Locale; synchronized with
	 * {@link #availableIsoLanguages}
	 */
	private List<Locale> availableLocales = new ArrayList<Locale>();
	/*
	 * All available Languages as ISO 639 2-letter codes. The first item is always
	 * "", the second is always "en"
	 */
	private List<String> availableIsoLanguages = new ArrayList<String>();
	/**
	 * All available LAFs (first entry is system default); synchronized with
	 * {@link #availableLafClassNames) *
	 */
	...
	private void initComponents() {
		...
		autoHighlightCandidateWhenColoring = new javax.swing.JCheckBox();
		...
		jPanel2.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ConfigGeneralPanel.jPanel2.border.title")));

		showCandidatesCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.showCandidatesCheckBox.mnemonic").charAt(0));
		showCandidatesCheckBox.setText(bundle.getString("ConfigGeneralPanel.showCandidatesCheckBox.text"));
		...
		showWrongValuesCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.showWrongValuesCheckBox.mnemonic").charAt(0));
		showWrongValuesCheckBox.setText(bundle.getString("ConfigGeneralPanel.showWrongValuesCheckBox.text"));
		...
		showDeviationsCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.showDeviationsCheckBox.mnemonic").charAt(0));
		showDeviationsCheckBox.setText(bundle.getString("ConfigGeneralPanel.showDeviationsCheckBox.text"));
		...
		saveWindowLayoutCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.saveWindowLayoutCheckBox.mnemonic").charAt(0));
		saveWindowLayoutCheckBox.setText(bundle.getString("ConfigGeneralPanel.saveWindowLayoutCheckBox.text"));
		...
		localLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.localLabel.mnemonic").charAt(0));
		localLabel.setLabelFor(localComboBox);
		localLabel.setText(bundle.getString("ConfigGeneralPanel.localLabel.text"));

		lookAndFeelLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.lookAndFeelLabel.mnemonic").charAt(0));
		lookAndFeelLabel.setLabelFor(lookAndFeelComboBox);
		lookAndFeelLabel.setText(bundle.getString("ConfigGeneralPanel.lookAndFeelLabel.text"));

		fontSizeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.fontSizeLabel.mnemonic").charAt(0));
		fontSizeLabel.setLabelFor(fontSizeTextField);
		fontSizeLabel.setText(bundle.getString("ConfigGeneralPanel.fontSizeLabel.text"));

		showColorKuCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.showColorKuCheckBox.mnemonic").charAt(0));
		showColorKuCheckBox.setText(bundle.getString("ConfigGeneralPanel.showColorKuCheckBox.text"));
		...
		defaultSizeCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.defaultSizeCheckBox.mnemonic").charAt(0));
		defaultSizeCheckBox.setText(bundle.getString("ConfigGeneralPanel.defaultSizeCheckBox.text"));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(jPanel2Layout.createSequentialGroup().addGroup(jPanel2Layout
						...
						.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
								.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(showCandidatesCheckBox).addComponent(showWrongValuesCheckBox)
										.addComponent(showDeviationsCheckBox).addComponent(saveWindowLayoutCheckBox)
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(localLabel).addComponent(localComboBox,
						...
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(lookAndFeelLabel).addComponent(lookAndFeelComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18).addComponent(defaultSizeCheckBox)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(fontSizeLabel).addComponent(fontSizeTextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(showColorKuCheckBox).addContainerGap(47, Short.MAX_VALUE)));

		resetButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.resetButton.mnemonic").charAt(0));
		resetButton.setText(bundle.getString("ConfigGeneralPanel.resetButton.text"));
		...
		jPanel4.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ConfigGeneralPanel.jPanel4.border.title")));

		shiftKeyCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.shiftKeyCheckBox.mnemonic").charAt(0));
		shiftKeyCheckBox.setText(bundle.getString("ConfigGeneralPanel.shiftKeyCheckBox.text"));

		onlySmallCursorsCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.onlySmallCursorsCheckBox.mnemonic").charAt(0));
		onlySmallCursorsCheckBox.setText(bundle.getString("ConfigGeneralPanel.onlySmallCursorsCheckBox.text"));

		colorValuesCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.colorValuesCheckBox.mnemonics").charAt(0));
		colorValuesCheckBox.setText(bundle.getString("ConfigGeneralPanel.colorValuesCheckBox.text"));

		showSudokuSolvedCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.showSudokuSolvedCheckBox.mnemonic").charAt(0));
		showSudokuSolvedCheckBox.setText(bundle.getString("ConfigGeneralPanel.showSudokuSolvedCheckBox.text"));

		deleteCursorAfterCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.deleteCursorAfterCheckBox.mnemonic").charAt(0));
		deleteCursorAfterCheckBox.setText(bundle.getString("ConfigGeneralPanel.deleteCursorAfterCheckBox.text"));
		...
		deleteCursorAfterMsTextField.setText(bundle.getString("ConfigGeneralPanel.deleteCursorAfterMsTextField.text"));

		jLabel1.setText(bundle.getString("ConfigGeneralPanel.jLabel1.text"));

		toggleFilterAndOrCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.toggleFilterAndOrCheckBox.mnemonic").charAt(0));
		toggleFilterAndOrCheckBox.setText(bundle.getString("ConfigGeneralPanel.toggleFilterAndOrCheckBox.text"));

		singleClickModeCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.singleClickModeCheckBox.mnemonic").charAt(0));
		singleClickModeCheckBox.setText(bundle.getString("ConfigGeneralPanel.singleClickModeCheckBox.text"));
		...
		onlySmallFiltersCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("ConfigGeneralPanel.onlySmallFiltersCheckBox.mnemonic").charAt(0));
		onlySmallFiltersCheckBox.setText(bundle.getString("ConfigGeneralPanel.onlySmallFiltersCheckBox.text"));
		...
		autoHighlightCandidateWhenColoring.setText(bundle.getString("ConfigGeneralPanel.autoHighlightCandidateWhenColoring.text"));
		...
		jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup().addContainerGap().addGroup(jPanel4Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(drawExtraBoxesCheckBox).addComponent(showSudokuSolvedCheckBox)
						.addComponent(colorValuesCheckBox).addComponent(onlySmallCursorsCheckBox)
						...
						.addComponent(autoHighlightCandidateWhenColoring)
	...
	private void deleteCursorAfterCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {
		deleteCursorAfterMsTextField.setEnabled(deleteCursorAfterCheckBox.isSelected());
	}

	private void defaultSizeCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {
		fontSizeTextField.setEnabled(!defaultSizeCheckBox.isSelected());
	}
	...
	public void okPressed() {
		...
		Options.getInstance().setAutoHighlightCandidateWhenColoring(autoHighlightCandidateWhenColoring.isSelected());
		Options.getInstance().setDrawMode(drawExtraBoxesCheckBox.isSelected() ? 0 : 1);

		if ((!Options.getInstance().isUseDefaultFontSize()
				&& (oldUseDefaultFontSize || oldFontSize != Options.getInstance().getCustomFontSize()))
				|| (Options.getInstance().isUseDefaultFontSize() && !oldUseDefaultFontSize)) {
			JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
					.getString("GeneralConfigPanel.restart_program2"));
		}

		language = availableIsoLanguages.get(localComboBox.getSelectedIndex());
		if (!language.equals(Options.getInstance().getLanguage())) {
			JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
					.getString("GeneralConfigPanel.restart_program"));
		}
...
//                }
	...
	private void initAll(boolean setDefault) {
		if (setDefault) {
			...
			autoHighlightCandidateWhenColoring.setSelected(Options.AUTO_HIGHLIGHT_CANDIDATE_WHEN_COLORING);
			...
			autoHighlightCandidateWhenColoring.setSelected(Options.getInstance().isAutoHighlightCandidateWhenColoring());
		...
		localComboBox.addItem(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("GeneralConfigPanel.automatic"));
		int languageIndex = 0;
	 ...
	 * languages, that are available as property files. The first entry is always
	 * "", which means "use system default". The second entry is always "en"
	...
	private void initLanguages() {
		...
		// try to load bundles for all existing languages, log those, for which an
		// actual bundle exists
	...
	/**
	 * Fills {@link #availableLafs} and {@link #availableLafClassNames}. The first
	 * entry stands for "system default".
	 */
	private void initLafs() {
		UIManager.LookAndFeelInfo[] lafs = UIManager.getInstalledLookAndFeels();
		availableLafs.clear();
		availableLafClassNames.clear();
		availableLafs.add(java.util.ResourceBundle.getBundle("intl/ConfigGeneralPanel")
				.getString("GeneralConfigPanel.system_default"));
	...
	private javax.swing.JCheckBox autoHighlightCandidateWhenColoring;
	...
	public static void main(String[] args) {
		...
		for (String isoLang : isoLanguages) {
			...
			ResourceBundle bundle = ResourceBundle.getBundle("intl/MainFrame", locale);
			System.out.println("  Returned: " + bundle.getLocale().toString() + " ("
					+ bundle.getLocale().getDisplayLanguage() + " - " + bundle.getString("MainFrame.error") + ")");
			if (bundle.getLocale().getLanguage().equals(isoLang)) {
