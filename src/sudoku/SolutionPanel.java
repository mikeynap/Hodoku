...
public class SolutionPanel extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		southPanelLayout
				.setHorizontalGroup(southPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(southPanelLayout.createSequentialGroup().addContainerGap().addComponent(weiterButton)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(alleEinfachenButton).addContainerGap(159, Short.MAX_VALUE)));

		southPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { alleEinfachenButton, weiterButton });
		...
		southPanelLayout.setVerticalGroup(southPanelLayout
				...
				.addGroup(southPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(southPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(weiterButton).addComponent(alleEinfachenButton))
	...
	private void solveFromHereMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
		getActTab();
	...
	private void deleteFromHereMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
		getActTab();
	...
	private void alleEinfachenButtonActionPerformed(java.awt.event.ActionEvent evt) {
		if (solver == null) {
			return;
		}
		getActTab();
		...
		while (actSelectedIndex < actSteps.size() - 1 && SolutionType
				.getStepConfig(actSteps.get(actSelectedIndex).getType()).getLevel() == DifficultyType.EASY.ordinal()) {
			weiterButtonActionPerformed(null);
		}
		if (actSelectedIndex < actSteps.size() && SolutionType.getStepConfig(actSteps.get(actSelectedIndex).getType())
				.getLevel() == DifficultyType.EASY.ordinal()) {
			weiterButtonActionPerformed(null);
		}
		mainFrame.fixFocus();
	}
	...
	private void tabNewMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
		getActTab();
		addTabPane(actSteps);
		mainFrame.fixFocus();
	}

	private void tabDeleteMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
		deleteTabPane();
		mainFrame.fixFocus();
	}

	private void solutionTabbedPaneStateChanged(javax.swing.event.ChangeEvent evt) {
	...
	private void processDoubleClick(int index) {
		...
		// wenn der aktuelle letzte Step INCOMPLETE ist, wird das Sudoku2 von hier weg
		// neu gelöst
