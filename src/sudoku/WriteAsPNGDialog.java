...
public class WriteAsPNGDialog extends javax.swing.JDialog {
	 ...
	 * @param einheit
	 */
	public WriteAsPNGDialog(java.awt.Frame parent, boolean modal, double size, int aufloesung, int einheit) {
		super(parent, modal);
		initComponents();
	...
	private void initComponents() {
		...
		sizePanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("WriteAsPNGDialog.sizePanel.border.title"))); // NOI18N

		sizeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
				.getString("WriteAsPNGDialog.sizeLabel.mnemonic").charAt(0));
		sizeLabel.setLabelFor(sizeTextField);
		sizeLabel.setText(bundle.getString("WriteAsPNGDialog.sizeLabel.text")); // NOI18N

		resolutionLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
				.getString("WriteAsPNGDialog.resolutionLabel.mnemonic").charAt(0));
		...
		sizePanelLayout
				.setHorizontalGroup(sizePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(sizePanelLayout.createSequentialGroup().addContainerGap()
								.addGroup(sizePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(sizeLabel).addComponent(resolutionLabel))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(sizePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(resolutionTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 174,
												Short.MAX_VALUE)
										.addComponent(sizeTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 174,
												Short.MAX_VALUE))
								.addContainerGap()));
		sizePanelLayout.setVerticalGroup(sizePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(sizePanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(sizePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE, false)
								.addComponent(sizeLabel).addComponent(
										sizeTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(sizePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE, false)
								.addComponent(resolutionLabel).addComponent(resolutionTextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addContainerGap()));

		einheitPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("WriteAsPNGDialog.einheitPanel.border.title"))); // NOI18N

		einheitButtonGroup.add(mmRadioButton);
		mmRadioButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
		...
		inchRadioButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
		...
		pixelRadioButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
		...
		einheitPanelLayout.setHorizontalGroup(einheitPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(einheitPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(einheitPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(mmRadioButton).addComponent(inchRadioButton)
								.addComponent(pixelRadioButton))
						.addContainerGap(49, Short.MAX_VALUE)));
		einheitPanelLayout
				.setVerticalGroup(einheitPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(einheitPanelLayout.createSequentialGroup().addComponent(mmRadioButton)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		bildSpeichernButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
		...
		abbrechenButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
				...
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup()
										.addComponent(sizePanel, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(einheitPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup().addComponent(bildSpeichernButton)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(abbrechenButton)))
						.addContainerGap()));

		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { abbrechenButton, bildSpeichernButton });

		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				.createSequentialGroup().addContainerGap()
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
						.addComponent(sizePanel, javax.swing.GroupLayout.Alignment.LEADING,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addComponent(einheitPanel, javax.swing.GroupLayout.Alignment.LEADING,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE))
				.addGap(18, 18, 18).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(abbrechenButton).addComponent(bildSpeichernButton))
				.addContainerGap()));
	...
	private void bildSpeichernButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bildSpeichernButtonActionPerformed
		...
		chooser.setFileFilter(new FileNameExtensionFilter("*.png "
				+ java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog").getString("WriteAsPNGDialog.files"),
				"png"));
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			if (!name.toLowerCase().endsWith(".png")) {
				...
				try {
					...
					JOptionPane.showMessageDialog(this,
							java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
									.getString("WriteAsPNGDialog.invalid_filename"),
							java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
									.getString("WriteAsPNGDialog.error"),
			...
			try {
				...
				JOptionPane.showMessageDialog(this,
						java.util.ResourceBundle.getBundle("intl/WriteAsPNGDialog")
								.getString("WriteAsPNGDialog.invalid_input_format"),
