...
public class FindAllStepsProgressDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		abbrechenButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/FindAllStepsProgressDialog")
				.getString("FindAllStepsProgressDialog.abbrechenButton.mnemonic").charAt(0));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(progressLabel,
								javax.swing.GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE))
						.addGroup(layout.createSequentialGroup().addGap(83, 83, 83).addComponent(abbrechenButton))
						.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(fishProgressBar,
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(progressLabel)
						...
						.addComponent(fishProgressBar, javax.swing.GroupLayout.PREFERRED_SIZE,
						...
						.addComponent(abbrechenButton).addContainerGap()));
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				progressLabel.setText(java.util.ResourceBundle.getBundle("intl/FindAllStepsProgressDialog")
						.getString("FindAllStepsProgressDialog.searching") + " " + label);
