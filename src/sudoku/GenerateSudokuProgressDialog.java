...
public class GenerateSudokuProgressDialog extends javax.swing.JDialog implements Runnable {
	...
	private void initComponents() {
		...
		cancelButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/GenerateSudokuProgressDialog")
				.getString("GenerateSudokuProgressDialog.cancelButton.mnemonic").charAt(0));
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(18, 18, 18).addComponent(progressLabel)
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				new GenerateSudokuProgressDialog(new javax.swing.JFrame(), true,
						Options.getInstance().getDifficultyLevels()[DifficultyType.EASY.ordinal()], GameMode.PLAYING)
								.setVisible(true);
			}
		});
	}*/
