...
public class ConfigDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		tabbedPane.addTab(bundle.getString("ConfigDialog.findAllStepsPanel.TabConstraints.tabTitle"),
				findAllStepsPanel); // NOI18N
		...
		cancelButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigDialog")
				.getString("ConfigDialog.cancelButton.mnemonic").charAt(0));
	...
	private void formWindowOpened(java.awt.event.WindowEvent evt) {// GEN-FIRST:event_formWindowOpened
		...
		int diff = (cancelButton.getY() + cancelButton.getHeight())
				- (getHeight() - getInsets().top - getInsets().bottom - 5);
		if (diff > 0) {
			newHeight += diff;
		}
